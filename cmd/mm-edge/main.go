...
func main() {
	var (
		...
		meshDomains  = flag.String("domains", "awwwe.uk", "comma-separated mesh domains this edge serves")
		gateways     = flag.String("gateways", "", "gateways to announce to: host:port|pubkey,...")
		publicAddr   = flag.String("public-addr", "", "the address agents should dial for the tunnel, e.g. edge1.awwwe.uk:7443")
